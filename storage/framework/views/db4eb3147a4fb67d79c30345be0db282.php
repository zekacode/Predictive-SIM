...
<body>
    <div class="container">
        <div class="card">
            ...
            <form action="<?php echo e(route('sales_data.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Zakki\Documents\Unesa File\Semester 4\Pengujian Perangkat Lunak\predictive-sim\resources\views/sales_data/create.blade.php ENDPATH**/ ?>